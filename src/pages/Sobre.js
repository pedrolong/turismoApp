    ...
    <View style={StylesSobre.container}>
      ...
      <ScrollView>
        <Text style={StylesSobre.txtSobre}>
          ...
          <Text style={StylesSobre.txtSobre}>
            {"\n"}
            Trek Trek nasceu do desejo de compartilhar a paixão pela exploração
            e pela descoberta de novos horizontes. Somos uma empresa de turismo
            especializada em oferecer experiências únicas e inesquecíveis para
            aqueles que buscam se conectar com a natureza, a cultura e a
          ...
          <Text style={StylesSobre.txttitulosobre}>O Que Oferecemos{"\n"}</Text>
          <Text style={StylesSobre.txtSobre}>
          ...
          <Text style={StylesSobre.txtSobre}>
            ...
            fazem. Eles são conhecedores das regiões que visitamos e estão
          ...
          <Text style={StylesSobre.txtSobre}>
            ...
            traz uma riqueza de conhecimento e experiência, garantindo que você
          ...
          <Text style={StylesSobre.txtSobre}>
            ...
            suas necessidades e desejos para oferecer uma viagem personalizada e
            única.
            {"\n"}
          </Text>
          <Text style={StylesSobre.titulocentral}>
